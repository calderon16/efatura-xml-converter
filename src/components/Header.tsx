...
import { FileSpreadsheet, Code2, ShieldCheck, BookOpen, FileCheck2 } from 'lucide-react';
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-xl font-extrabold text-slate-900 tracking-tight">
                e-Fatura <span className="text-blue-600 font-semibold">XML Platformu</span>
              </h1>
            ...
            <p className="text-xs text-slate-500 font-medium">
              Türkiye Standartlarında e-Fatura & e-Arşiv Dönüştürücü ve Doğrulama
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center bg-slate-100 p-1 rounded-xl border border-slate-200 text-xs font-bold gap-0.5">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg transition-all flex items-center gap-1.5 ${
              !isValidator && !isGuides && currentTool === 'excel'
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg transition-all flex items-center gap-1.5 ${
              !isValidator && !isGuides && currentTool === 'json'
                ? 'bg-white text-blue-700 shadow-xs border border-slate-200'
                : 'text-slate-600 hover:text-slate-900'
            }`}
          >
